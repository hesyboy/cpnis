        ...
        <div class="text-center text-white px-6 md:px-12">
          ...
          <nav class="bg-grey-light rounded-md w-full">
            <ol class="list-reset flex justify-center gap-2 font-semibold">
              ...
              <li><span> > </span></li>
              <li><a class="text-yellow-500 hover:text-yellow-600">Tasks</a></li>
            </ol>
          </nav>
        </div>
      </div>
                      ...
                      <table class="min-w-full rounded overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b transition duration-300 ease-in-out  hover:translate-x-5 hover:font-semibold">
                                ...
                                <td class="text-xs text-gray-900 px-6 py-4 whitespace-nowrap">
                                    <span class=" bg-blue-800 text-white rounded p-1">
                                        {{$item->getCreator->name}}
                                    </span>
                                </td>
                                <td class="text-xs text-gray-900 px-6 py-4 whitespace-nowrap">
                                    <span class=" bg-orange-600 text-white rounded p-1">
                                        {{$item->getWorker->name}}
                                    </span>
                                </td>
                                ...
                                <td class="text-xs text-gray-900 px-6 py-4 whitespace-nowrap">
                                    <span class="bg-emerald-800 text-white rounded p-1">
                                        {{$item->priority_id}}
                                    </span>
                                </td>
                                <td class="text-xs text-gray-900 px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="text-xs text-gray-900 px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-6">
                                        <form action="{{route('tasks.index')}}">
                                            ...
                                            <button type="submit" class="flex flex-col gap-1 items-center text-gray-800 hover:text-blue-800 text-xl hover:scale-110 transition">
