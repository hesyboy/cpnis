<nav class="
  ...
  <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
    ...
    <li class="nav-item p-2">
        <a class="nav-link text-gray-500 hover:text-gray-900 focus:text-gray-900 p-0" href="{{route('activities.index')}}">Activities</a>
    </li>
          ...
          <li>
            <a
              class="
                ...
                hover:bg-gray-100
              "
              href="{{route('documents.types.index')}}"
              >Document Types</a
            >
          </li>
      </ul>
  ...
  <div class="dropdown relative">
    ...
    <div class="text-right">
        <div class="mx-3 text-right">{{auth()->user()->name}} - #{{auth()->id()}}</div>
        <div class="mx-3 text-xs">{{auth()->user()->email}}</div>
    </div>
